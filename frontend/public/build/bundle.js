...
var app = (function () {
    ...
    const file$b = "src/Toolbar.svelte";
    ...
    /* node_modules/svelte-keyboard/src/Keyboard.svelte generated by Svelte v3.59.2 */
    ...
    /* src/Puzzle.svelte generated by Svelte v3.59.2 */
    const file$8 = "src/Puzzle.svelte";
    ...
    /* src/Clue.svelte generated by Svelte v3.59.2 */
    const file$7 = "src/Clue.svelte";
    ...
    /* src/ClueList.svelte generated by Svelte v3.59.2 */
    const file$6 = "src/ClueList.svelte";
    ...
    /* src/ClueBar.svelte generated by Svelte v3.59.2 */
    const file$5 = "src/ClueBar.svelte";
    ...
    /* src/Clues.svelte generated by Svelte v3.59.2 */
    const file$4 = "src/Clues.svelte";
    ...
    /* src/Confetti.svelte generated by Svelte v3.59.2 */
    ...
    /* src/CompletedMessage.svelte generated by Svelte v3.59.2 */
    const file$2 = "src/CompletedMessage.svelte";
    ...
    /* src/Crossword.svelte generated by Svelte v3.59.2 */
    const file$1 = "src/Crossword.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Crossword";
    			t1 = space();
    			p = element("p");
    			p.textContent = "A NYT daily puzzle with all default settings.";
    			t3 = space();
    			create_component(crossword.$$.fragment);
    			attr_dev(h1, "class", "svelte-1ncem29");
    			add_location(h1, file, 21, 2, 481);
    			add_location(p, file, 22, 2, 502);
    			attr_dev(main, "class", "svelte-1ncem29");
    			add_location(main, file, 20, 0, 472);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, p);
    			append_dev(main, t3);
    			mount_component(crossword, main, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const crossword_changes = {};
    			if (dirty & /*dataNYTDaily*/ 1) crossword_changes.data = /*dataNYTDaily*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		try {
    			...
    			if (response.ok) {
    				$$invalidate(0, dataNYTDaily = await response.json());
    			} else {
    	...
    	$$self.$capture_state = () => ({ onMount, Crossword, dataNYTDaily });

    	$$self.$inject_state = $$props => {
    		if ('dataNYTDaily' in $$props) $$invalidate(0, dataNYTDaily = $$props.dataNYTDaily);
    	};
